...
export default function BudgetStep({ onSubmit, onEditProfile }: BudgetStepProps) {
  ...
  return (
    <div className="flex h-full flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold text-campus-ink">Ton budget</h1>
        <p className="mt-1 text-sm text-campus-muted">
          Combien veux-tu dépenser cette semaine ?
        </p>
      </div>
      ...
      <div className="flex-1 space-y-6">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-campus-muted">par semaine</p>
        </div>
      ...
      <div className="flex flex-col gap-3 pt-2">
        ...
        >
          Modifier mes préférences (régime, allergies, calories...)
        </button>
      </div>
    </div>
  );
