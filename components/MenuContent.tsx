...
import { buildWeeklyPlan, WEEKDAY_LABELS } from "@/lib/generateMenu";
import {
  MEAL_SLOT_ICONS,
  MEAL_SLOT_LABELS,
  MEAL_SLOT_ORDER,
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-campus-muted">
          Ta liste répartie jour par jour
        </p>
      </div>
      ...
      {isEmpty ? (
        ...
        <>
          ...
          <div className="space-y-4">
                    ...
                    {entries.map(({ product, count }) => (
                      ...
                      >
                        ...
                        <span className="shrink-0 font-semibold text-campus-terracotta">
                          {count} {count > 1 ? `${product.servingUnit}s` : product.servingUnit}
                        </span>
                      </li>
                    ))}
                  </ul>
            ...
            {MEAL_SLOT_ORDER.every((slot) => day.slots[slot].length === 0) && (
              <div className="rounded-2xl border border-campus-sand bg-white p-5 text-center">
                <p className="text-sm text-campus-muted">
